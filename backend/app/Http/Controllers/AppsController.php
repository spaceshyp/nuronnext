...
class AppsController extends Controller
{
    ...
    public function invoice_list()
    {
        ...
        return view('/content/invoice/app-invoice-list', ['pageConfigs' => $pageConfigs]);
    }
    ...
    public function invoice_preview()
    {
        ...
        return view('/content/invoice/app-invoice-preview', ['pageConfigs' => $pageConfigs]);
    }
    ...
    public function invoice_edit()
    {
        ...
        return view('/content/invoice/app-invoice-edit', ['pageConfigs' => $pageConfigs]);
    }
    ...
    public function invoice_add()
    {
        ...
        return view('/content/invoice/app-invoice-add', ['pageConfigs' => $pageConfigs]);
    }
    ...
    public function invoice_print()
    {
        ...
        return view('/content/invoice/app-invoice-print', ['pageConfigs' => $pageConfigs]);
    }
    ...
    {
        $pageConfigs = ['pageHeader' => false];
        return view('/content/user/app-user-list', ['pageConfigs' => $pageConfigs]);
    }
    ...
    {
        $pageConfigs = ['pageHeader' => false];
        return view('/content/user/app-user-view-account', ['pageConfigs' => $pageConfigs]);
    }
    ...
    {
        $pageConfigs = ['pageHeader' => false];
        return view('/content/user/app-user-view-security', ['pageConfigs' => $pageConfigs]);
    }
    ...
    {
        $pageConfigs = ['pageHeader' => false];
        return view('/content/user/app-user-view-billing', ['pageConfigs' => $pageConfigs]);
    }
    ...
    {
        $pageConfigs = ['pageHeader' => false];
        return view('/content/user/app-user-view-notifications', ['pageConfigs' => $pageConfigs]);
    }
    ...
    {
        $pageConfigs = ['pageHeader' => false];
        return view('/content/user/app-user-view-connections', ['pageConfigs' => $pageConfigs]);
    }
    ...
    public function calendarApp()
    {
        ...
        return view('/content/calendar/app-calendar', [
            'pageConfigs' => $pageConfigs
        ]);
    }
    ...
    public function emailApp()
    {
        ...
        return view('/content/email/app-email', ['pageConfigs' => $pageConfigs]);
    }
    // ToDo App
    public function todoApp()
    {
        ...
        return view('/content/todo/app-todo', [
            'pageConfigs' => $pageConfigs
        ]);
    }
    // File manager App
    ...
    public function access_roles()
    {
        ...
        return view('/content/rolesPermission/app-access-roles', ['pageConfigs' => $pageConfigs]);
    }
    ...
    public function access_permission()
    {
        ...
        return view('/content/rolesPermission/app-access-permission', ['pageConfigs' => $pageConfigs]);
    }
    ...
    public function kanbanApp()
    {
        ...
        return view('/content/kanban/app-kanban', ['pageConfigs' => $pageConfigs]);
    }
